...
public class Akun extends javax.swing.JPanel {
    ...
    private final MahasiswaModel mahasiswaModel;
    ...
    public Akun(JScrollPane contentScrollPane) {
        ...
        initComponents();
        mahasiswaModel = new MahasiswaModel(this);
    ...
    private void loadMahasiswaData() {
        Mahasiswa mahasiswa = mahasiswaModel.getCurrentMahasiswa();
        if (mahasiswa != null) {
    ...
    private void loadRuanganData() {
        int mahasiswaId = mahasiswaModel.getCurrentMahasiswa().getId();
    ...
    private void initComponents() {
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 390, -1, -1));

        jLabel8.setForeground(new java.awt.Color(204, 255, 255));
        jLabel8.setText("0: available");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 410, -1, -1));

        jLabel2.setForeground(new java.awt.Color(204, 255, 255));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/Plain.png"))); // NOI18N
        jLabel2.setText("1: booked");
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (isEditing) {
            ...
            if (response == JOptionPane.YES_OPTION) {
                ...
                boolean updated = mahasiswaModel.updateMahasiswa(mahasiswa);
                if (updated) {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            if (response == JOptionPane.YES_OPTION) {
                DefaultTableModel model = (DefaultTableModel) tableRuangan.getModel();
                String ruang = (String) model.getValueAt(selectedRow, 1);
                java.sql.Date tanggal = (java.sql.Date) model.getValueAt(selectedRow, 2);
