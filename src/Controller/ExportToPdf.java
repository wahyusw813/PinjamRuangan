...
public class ExportToPdf {
    ...
    public void exportToPdf(String ruang, String tanggal, String sesi1, String sesi2, String sesi3, String sesi4) throws IOException {
        try {
            ...
            String keterangan = getter.getKeteranganFromDatabase(ruang, tanggal);
            ...
            Paragraph para5 = new Paragraph("      Sehubungan dengan akan diadakannya kegiatan " + keterangan + ", kami bermaksud mengajukan peminjaman Ruang " + ruang + " yang akan digunakan pada:\n", normalFont);
